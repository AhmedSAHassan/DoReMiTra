...
```{r}
extract_and_save_SE_parts <- function(prefix = "Neutron_GSE", output_dir = ".") {
...
```{r}
extract_and_save_SE_parts(prefix = "Neutron_GSE", output_dir = "inst/extdata/Neutron")
```

# Creating a SE object for each dataset

```{r}
assemble_SE_from_RDS <- function(input_dir = "inst/extdata/Neutron", prefix = "Neutron_GSE") {
...
```{r}
Neutron_se_objects <- assemble_SE_from_RDS(input_dir = "inst/extdata/Neutron", prefix = "Neutron_GSE")
```
