...
colData(all_se_list$SE_Amundson_2019_vivo_GSE124612_GPL11202) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Aryankalayil_2018_vivo_GSE104121_GPL10787) |> as.data.frame() |> View()
...
all_se_list$SE_Aryankalayil_2018_vivo_GSE104121_GPL10787$Dose <- str_replace_all(
    str_extract(all_se_list$SE_Aryankalayil_2018_vivo_GSE104121_GPL10787$treatment.ch1,
        "\\d+(\\.\\d+)?\\s*Gy"), "\\s+", "")
...
all_se_list$SE_Aryankalayil_2018_vivo_GSE104121_GPL21163$Dose <- str_replace_all(
    str_extract(all_se_list$SE_Aryankalayil_2018_vivo_GSE104121_GPL21163$treatment.ch1,
        "\\d+(\\.\\d+)?\\s*Gy"), "\\s+", "")
...
colData(all_se_list$SE_Park_2017_vitro_GSE102971_GPL10332) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Vasilyev_2017_vitro_GSE97000_GPL17077) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Paul_2013_vitro_GSE44201_GPL6480) |> as.data.frame() |> View()
...
colData(all_se_list$SE_NOSEL_2013_vitro_GSE43151_GPL13497) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Girardi_2012_vitro_GSE20173_GPL6480) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Amundson_2011_vitro_GSE23515_GPL6480) |> as.data.frame() |> View()
...
colData(all_se_list$SE_GRUEL_2008_vitro_GSE6978_GPL4803) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Rouchka_2019_vitro_GSE63952_GPL15207) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Amundson_2008_vitro_GSE8917_GPL1708) |> as.data.frame() |> View()
...
colData(all_se_list$SE_MANIKANDAN_2014_vitro_GSE36355_GPL6883) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Lee_2013_vitro_GSE44245_GPL570) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Rouchka_2015_vitro_GSE64375_GPL6244) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Ankermit_2015_vitro_GSE55953_GPL14550) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Broustas_2018_vivo_GSE113509_GPL11202) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Broustas_2017_vivo_GSE85323_GPL10333) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Broustas_2017_vitro_GSE90909_GPL13497) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Paul_2010_vivo_GSE23393_GPL6480) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Ghandhi_2015_vitro_GSE65292_GPL13497) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Amundson_2011_vivo_GSE20162_GPL6480) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Broustas_2023_vivo_GSE196400_GPL11202) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Broustas_2022_vivo_GSE184361_GPL11202) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Broustas_2021_vivo_GSE132559_GPL11202) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Yamaguchi_2020_vivo_GSE137192_GPL1261) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Mukherjee_2019_vivo_GSE114142_GPL11202) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Amundson_2018_vivo_GSE101402_GPL11202) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Amundson_2018_vivo_GSE99176_GPL11202) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Paul_2015_vivo_GSE62623_GPL10333) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Ghandhi_2018_vivo_GSE84898_GPL13497) |> as.data.frame() |> View()
...
colData(all_se_list$SE_Broustas_2021_vivo_GSE133451_GPL11202) |> as.data.frame() |> View()
