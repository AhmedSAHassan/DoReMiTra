...
TODOAHMED: if we have ALL this info (or most of it) encoded like this, it becomes fairly easy to have a "se-summary" to have an overview on each study - could be a nice function that tells a bit about the data "in a glance"?
