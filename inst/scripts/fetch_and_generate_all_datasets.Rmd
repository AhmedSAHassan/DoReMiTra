...
```{r}
SE_Amundson_2019_vivo_GSE124612_GPL11202 <- process_geo_dataset(
...
colData(SE_Amundson_2019_vivo_GSE124612_GPL11202) |>
  as.data.frame() |>
  DT::datatable()
...
# Dose
SE_Amundson_2019_vivo_GSE124612_GPL11202$Dose <- ifelse(
  grepl("control", SE_Amundson_2019_vivo_GSE124612_GPL11202$treatment.ch1, ignore.case = TRUE),
  "Control",
  str_replace_all(
    str_extract(
      SE_Amundson_2019_vivo_GSE124612_GPL11202$treatment.ch1,
      "\\d+(\\.\\d+)?\\s*Gy"
    ),
    "\\s+",
    ""
...
# Radiation type
SE_Amundson_2019_vivo_GSE124612_GPL11202$Radiation_type <- rep("gamma ray", 248)

# Sex
SE_Amundson_2019_vivo_GSE124612_GPL11202$Sex <- str_to_title(SE_Amundson_2019_vivo_GSE124612_GPL11202$Sex.ch1)

# Time
SE_Amundson_2019_vivo_GSE124612_GPL11202$Time_point <- str_replace_all(
  str_extract(SE_Amundson_2019_vivo_GSE124612_GPL11202$treatment.ch1, "Day[_\\s]*\\d+"),
  "[_\\s]+", ""
)

# organism
SE_Amundson_2019_vivo_GSE124612_GPL11202$Organism <- SE_Amundson_2019_vivo_GSE124612_GPL11202$organism_ch1

# age
SE_Amundson_2019_vivo_GSE124612_GPL11202$Age <- SE_Amundson_2019_vivo_GSE124612_GPL11202$age.ch1

# sample id
SE_Amundson_2019_vivo_GSE124612_GPL11202$Sample_id <- colnames(SE_Amundson_2019_vivo_GSE124612_GPL11202)

# taxonomy id
SE_Amundson_2019_vivo_GSE124612_GPL11202$TaxonomyId <- SE_Amundson_2019_vivo_GSE124612_GPL11202$taxid_ch1 

# experimental setting
SE_Amundson_2019_vivo_GSE124612_GPL11202$Exp_setting <- rep("vivo", 248)

## TODOAHMED: to me, HERE is where we assign this to the list object
all_se_list[["SE_Amundson_2019_vivo_GSE124612_GPL11202"]] <- SE_Amundson_2019_vivo_GSE124612_GPL11202
...
```{r}
save_se_objects(all_se_list, "./DoReMiTra/SE")
```
