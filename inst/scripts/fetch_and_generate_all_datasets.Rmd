...
## Convert ensemble id to gene symbol, remove NA, choose the highest variable gene symbol in case of genes with multipe ensembel id, and add the resulting gene symbols as rownames
...
saveRDS(SE_Salah_2025_vitro, "DoReMiTra/SE/SE_Salah_2025_vitro.RDS")
