...
metadata$Description[34]<- "Processed expression data from GitHub repository AhmedSAHassan/Phybion_ShortReads_Analysis related to X-ray exposure."

metadata$SourceType[34]<- "RDS"
metadata$DataProvider[34]<- "GitHub"

metadata$Radiation_type[17:19]<- "Neutron; X-ray"
