...
process_geo_dataset <- function(
  ...
  for (i in seq_along(gse_list)) {
    ...
    final_se <- SummarizedExperiment::SummarizedExperiment(
      assays = list(ExprsValues = counts),
      rowData = rd,
      colData = cd
    )
...
all_se_list$SE_Amundson_2019_vivo_GSE124612_GPL11202$Exp_setting <- rep("InVivo", 248)
...
# experimental setting
all_se_list$SE_Aryankalayil_2018_vivo_GSE104121_GPL10787$Exp_setting <- rep("InVivo", 24)
...
# experimental setting
all_se_list$SE_Aryankalayil_2018_vivo_GSE104121_GPL21163$Exp_setting <- rep("InVivo", 24)
...
# experimental setting
all_se_list$SE_Park_2017_vitro_GSE102971_GPL10332$Exp_setting <- rep("ExVivo", 167)
...
# experimental setting
all_se_list$SE_Vasilyev_2017_vitro_GSE97000_GPL17077$Exp_setting <- rep("ExVivo", 12)
...
# experimental setting
all_se_list$SE_Paul_2013_vitro_GSE44201_GPL6480$Exp_setting <- rep("ExVivo", 25)
...
# experimental setting
all_se_list$SE_Paul_2013_vitro_GSE44201_GPL6848$Exp_setting <- rep("ExVivo", 50)
...
# experimental setting
all_se_list$SE_NOSEL_2013_vitro_GSE43151_GPL13497$Exp_setting <- rep("ExVivo", 121)
...
# experimental setting
all_se_list$SE_Girardi_2012_vitro_GSE20173_GPL6480$Exp_setting <- rep("ExVivo", 20)
...
# experimental setting
all_se_list$SE_Amundson_2011_vitro_GSE23515_GPL6480$Exp_setting <- rep("ExVivo", 95)
...
Entrez<- rowData(all_se_list$SE_GRUEL_2008_vitro_GSE6978_GPL4803)$GENE
...
rowData(all_se_list$SE_GRUEL_2008_vitro_GSE6978_GPL4803)$SYMBOL<- Entrez_to_symbol

# assigning the corrected gene symbols to the rownames of the se object

rownames(all_se_list$SE_GRUEL_2008_vitro_GSE6978_GPL4803) <- rowData(all_se_list$SE_GRUEL_2008_vitro_GSE6978_GPL4803)$SYMBOL
...
# experimental setting
all_se_list$SE_GRUEL_2008_vitro_GSE6978_GPL4803$Exp_setting <- rep("ExVivo", 114)
...
# experimental setting
all_se_list$SE_Rouchka_2019_vitro_GSE63952_GPL15207$Exp_setting <- rep("ExVivo", 100)
...
# experimental setting
all_se_list$SE_Amundson_2008_vitro_GSE8917_GPL1708$Exp_setting <- rep("ExVivo", 50)
...
# experimental setting
all_se_list$SE_MANIKANDAN_2014_vitro_GSE36355_GPL6883$Exp_setting <- rep("ExVivo", 16)
...
# experimental setting
all_se_list$SE_Lee_2013_vitro_GSE44245_GPL570$Exp_setting <- rep("ExVivo", 6)
...
se <- all_se_list$SE_Rouchka_2015_vitro_GSE64375_GPL6244
...
# Build final SE
cd <- colData(se)
all_se_list$SE_Rouchka_2015_vitro_GSE64375_GPL6244 <- SummarizedExperiment::SummarizedExperiment(
...
# experimental setting
all_se_list$SE_Rouchka_2015_vitro_GSE64375_GPL6244$Exp_setting <- rep("ExVivo", 16)
...
# experimental setting
all_se_list$SE_Ankermit_2015_vitro_GSE55953_GPL14550$Exp_setting <- rep("ExVivo", 28)
...
# experimental setting
all_se_list$SE_Broustas_2018_vivo_GSE113509_GPL11202$Exp_setting <- rep("InVivo", 18)
...
# experimental setting
all_se_list$SE_Broustas_2017_vivo_GSE85323_GPL10333$Exp_setting <- rep("InVivo", 72)
...
# experimental setting
all_se_list$SE_Broustas_2017_vitro_GSE90909_GPL13497$Exp_setting <- rep("ExVivo", 92)
...
# experimental setting
all_se_list$SE_Paul_2010_vivo_GSE23393_GPL6480$Exp_setting <- rep("InVivo", 16)
...
# experimental setting
all_se_list$SE_Ghandhi_2015_vitro_GSE65292_GPL13497$Exp_setting <- rep("ExVivo", 35)
...
all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332$Radiation_type <- rep("X-ray", 24)

# sex
all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332$Sex <- all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332$gender.ch1

# organism
all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332$Organism <- all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332$organism_ch1


# sample id
all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332$Sample_id <- colnames(all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332)

# taxonomy id
all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332$TaxonomyId <- all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332$taxid_ch1 

# experimental setting
all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332$Exp_setting <- rep("ExVivo", 24)

print(all_se_list$SE_Flores_2009_vitro_GSE15341_GPL8332)
```
...
# experimental setting
all_se_list$SE_Amundson_2011_vivo_GSE20162_GPL6480$Exp_setting <- rep("InVivo", 66)
...
# experimental setting
all_se_list$SE_Broustas_2023_vivo_GSE196400_GPL11202$Exp_setting <- rep("InVivo", 24)
...
# experimental setting
all_se_list$SE_Broustas_2022_vivo_GSE184361_GPL11202$Exp_setting <- rep("InVivo", 30)
...
# experimental setting
all_se_list$SE_Broustas_2021_vivo_GSE132559_GPL11202$Exp_setting <- rep("InVivo", 24)
...
# experimental setting
all_se_list$SE_Yamaguchi_2020_vivo_GSE137192_GPL1261$Exp_setting <- rep("InVivo", 17)
...
# experimental setting
all_se_list$SE_Mukherjee_2019_vivo_GSE114142_GPL11202$Exp_setting <- rep("InVivo", 20)
...
# experimental setting
all_se_list$SE_Amundson_2018_vivo_GSE101402_GPL11202$Exp_setting <- rep("InVivo", 24)
...
# experimental setting
all_se_list$SE_Amundson_2018_vivo_GSE99176_GPL11202$Exp_setting <- rep("InVivo", 32)
...
# experimental setting
all_se_list$SE_Paul_2015_vivo_GSE62623_GPL10333$Exp_setting <- rep("InVivo", 48)
...
# experimental setting
all_se_list$SE_Ghandhi_2018_vivo_GSE84898_GPL13497$Exp_setting <- rep("InVivo", 20)
...
# experimental setting
all_se_list$SE_Broustas_2021_vivo_GSE133451_GPL11202$Exp_setting <- rep("InVivo", 20)
...
```
curl -L -o SE_Salah_2025_vitro.RDS \
...
```{r eval=TRUE}
# fetch the dataset
dest_tempfile_salah <- file.path(tempdir(), "SE_Salah_2025_vitro.RDS")
...
SE_Salah_2025_vitro<- readRDS(dest_tempfile_salah) |> as("SummarizedExperiment")

# convert gencode id to ensemble id
rownames(SE_Salah_2025_vitro) <- substr(rownames(SE_Salah_2025_vitro), start = 1, stop = 15)
...
# experimental setting
SE_Salah_2025_vitro$Exp_setting <- rep("ExVivo", 30)
...
print(all_se_list$SE_Salah_2025_vitro)
```
